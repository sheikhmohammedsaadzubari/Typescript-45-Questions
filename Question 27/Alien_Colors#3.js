...
console.log("First version where alien color is ".concat(alien_color, ":"));
...
alien_color = 'yellow';
console.log("Second version where alien color is ".concat(alien_color, ":"));
if (alien_color === 'green') {
    console.log('Congratulations! you just earned 5 points for shooting the alien.\n');
}
else if (alien_color === 'yellow') {
...
// • If the alien is red, print a message that the player earned 15 points.
alien_color = 'red';
console.log("Third version where alien color is ".concat(alien_color, ":"));
if (alien_color === 'green') {
    console.log('Congratulations! you just earned 5 points for shooting the alien.\n');
}
else if (alien_color === 'yellow') {
